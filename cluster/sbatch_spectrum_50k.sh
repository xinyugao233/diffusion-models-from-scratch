#!/usr/bin/env bash
#SBATCH --job-name=cifar_spectrum_50k
...
job_scratch=${SLURM_TMPDIR:-/tmp/${USER}/spectrum-50k-${SLURM_JOB_ID}}
...
data_dir=/home/xggh8/datasets/cifar10/cifar-10-batches-py
artifact_root=/home/xggh8/data/diffusion-models-from-scratch/spectrum-50k
...
mkdir -p "$job_output"
cd "$repository"
"$environment_root/bin/python" scripts/compare_cifar10_radial_power.py \
  --data-dir "$data_dir" \
  --reference-csv configs/cifar10_e006_radial_power.csv \
